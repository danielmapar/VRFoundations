...
public class Key : MonoBehaviour {
	...
	public void OnKeyClicked () {
        ...
        Object.Instantiate(keyPoofPrefab, transform.position, effectRotation);
        GetComponent<Renderer>().enabled = false;
        // Disabling colliders from the GameObject (no highlight when mousing over)
        // We have 2 colliders in this GameObject (two box colliders)
